...
public class JumpGuruClient extends JFrame implements KeyListener, Runnable, WindowListener {

    // - Variables - //
    // - Frame - //
    private static final String TITLE = "JumpGuru::client";
    ...
    public JumpGuruClient(String clientname, String portAdd, String ipAdd) {
