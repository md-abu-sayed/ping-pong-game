...
public class JumpGuruServer extends JFrame implements KeyListener, Runnable, WindowListener {

    // - Variables - //
    // - Frame - //
    private static final String TITLE = "Jump guru::server";
    ...
    // - Constructor - //
    public JumpGuruServer(String servername, String portAdd) {
                ...
                while (true) {
                    ...
                    if (playerS.getScoreP() >= max_Score || playerS.getScoreS() >= max_Score && Restart == false) {
                        ...
                        if (playerS.getScoreS() > playerS.getScoreP()) {
                            playerS.setOmessage("Won               Loss-Play Again: || Exit: Esc");
                            playerS.setImessage("Won               Loss-Play again: ||Exit:Esc ");
                            Restart = true;
                        } else {
                            playerS.setImessage("Loss              Won-Play Again: || Exit: Esc");
                            playerS.setOmessage("Loss              Won-Play Again: || Exit: Esc");
                            Restart = true;
                        }
    ...
    private Image createImage() {
        ...
        g.setColor(new Color(228, 38, 36));
        g.fillOval(playerS.getBallx() + 5, playerS.getBally() + 5, 35, 35);
